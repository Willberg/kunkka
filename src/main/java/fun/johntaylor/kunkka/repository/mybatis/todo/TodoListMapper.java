...
public interface TodoListMapper {
	...
	@Insert("insert into t_todo_list(id, uid, value, finish_value, total_time, max_time, min_priority, create_time, update_time, status) values(#{id}, #{uid}, #{value}, #{finishValue}, #{totalTime}, #{maxTime}, #{minPriority}, #{createTime}, #{updateTime}, #{status})")
